...
int main(int argc, char **argv) {
  if (argc <= 1) {
    printf("Usage: %s [options] output-file\n"
           ...
           "    -i, --iterations   Number of iterations to check; default is "
           "1000\n"
           ...
           "\n"
           "Example usage: ./mandelbrot-gen --center -.745,.13 -x -.008,.008 "
           "-w 5464 -h 3072 out.ppm\n"
           "Another example identical to the former: ./mandelbrot-gen -x "
           "-.753,-.737 -y .12550219619326503,.13449780380673498 -w 5464 -h "
           "3072 out.ppm\n"
...
#undef param_chk
  ...
  generate(output_file, image_width, image_height, xmin, xmax, ymin, ymax, 256,
           iterations);
  return 0;
}